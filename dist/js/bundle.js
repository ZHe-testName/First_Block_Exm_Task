...
/*!*****************************!*\
  !*** ./src/js/_hendlers.js ***!
  \*****************************/
/*! exports provided: showHideHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _js_modules_sliders__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../js/modules/_sliders */ "./src/js/modules/_sliders.js");
/* harmony import */ var _js_hendlers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../js/_hendlers */ "./src/js/_hendlers.js");
/* harmony import */ var _js_modules_header__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../js/modules/_header */ "./src/js/modules/_header.js");
/* harmony import */ var _js_modules_main_menu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../js/modules/_main-menu */ "./src/js/modules/_main-menu.js");
/* harmony import */ var _js_modules_repair__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../js/modules/_repair */ "./src/js/modules/_repair.js");
/* harmony import */ var _js_modules_repair__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_js_modules_repair__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _js_modules_services__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../js/modules/_services */ "./src/js/modules/_services.js");
/* harmony import */ var _js_modules_services__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_js_modules_services__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _js_modules_navigation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../js/modules/_navigation */ "./src/js/modules/_navigation.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _hendlers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../_hendlers */ "./src/js/_hendlers.js");
...
header.addEventListener('click', function (event) {
  ...
  if (target.classList.contains('basic-button--burger-bg')) {
    Object(_hendlers__WEBPACK_IMPORTED_MODULE_0__["showHideHandler"])(mainMenu, closeBtn);
  }

  if (target.classList.contains('basic-button--chat-bg')) {
    Object(_hendlers__WEBPACK_IMPORTED_MODULE_0__["showHideHandler"])(feedbackBlock, feedbackCloseButton);
  }

  if (target.classList.contains('basic-button--call-bg')) {
    Object(_hendlers__WEBPACK_IMPORTED_MODULE_0__["showHideHandler"])(callbackBlock, callbackCloseButton);
  }
});

/***/ }),

/***/ "./src/js/modules/_main-menu.js":
/*!**************************************!*\
  !*** ./src/js/modules/_main-menu.js ***!
  \**************************************/
/*! no exports provided */
...
mainMenu.parentElement.addEventListener('click', function (event) {
  var target = event.target;
  ...
  if (target.classList.contains('basic-button--chat-bg')) {
    Object(_hendlers__WEBPACK_IMPORTED_MODULE_0__["showHideHandler"])(feedbackBlock, feedbackCloseButton); //Immit the event on closing button
    //for shut menu window

    if (document.documentElement.clientWidth < 1440) {
      var _event = new Event('click');

      closeButton.dispatchEvent(_event);
    }
  }
  ...
  if (target.classList.contains('basic-button--call-bg')) {
    ...
    if (document.documentElement.clientWidth < 1440) {
      ...
      closeButton.dispatchEvent(_event2);
    }
  }

  if (target.classList.contains('menu-wrap')) {
    Object(_hendlers__WEBPACK_IMPORTED_MODULE_0__["showHideHandler"])(mainMenu, closeButton, true);
  }
});
...
/***/ "./src/js/modules/_modal-callback.js":
/*!*******************************************!*\
  !*** ./src/js/modules/_modal-callback.js ***!
  \*******************************************/
/*! no exports provided */
...
/***/ "./src/js/modules/_modal-feedback.js":
/*!*******************************************!*\
  !*** ./src/js/modules/_modal-feedback.js ***!
  \*******************************************/
/*! no exports provided */
...
menuNavigation.addEventListener('click', function (event) {
  var target = event.target;

  if (target.classList.contains('services-slider__text')) {
    servicesSliderItems.forEach(function (item) {
...
var cardsBlock = document.querySelector('.repair-cards'),
...
showBtn.addEventListener('click', function () {
  ...
  if (flag) {
    ...
    var elemsAmount = allLinks.length;
    var elemsInRow = 0; //calculate amount elements in the row relatively to screen width
    ...
    cardsBlock.setAttribute('style', " height: ".concat(elemsAmount / elemsInRow * elemHeight, "px;\n                                        transition: height;\n                                        transition-duration: 0.7s;\n                                        transition-timing-function: ease-in;"));
...
var servicesParText = document.querySelector('.services__par-text'),
...
var flag = true;
servicesReadmoreButton.addEventListener('click', function () {
  showBtn.classList.toggle('services__readmore-button--active');

  if (flag) {
    //insert inline style into screan element for smooth animation
    servicesTextWrap.setAttribute('style', " height: ".concat(servicesParText.clientHeight, "px;\n                                        transition: height;\n                                        transition-duration: 0.6s;\n                                        transition-timing-function: ease-in;"));
    showBtn.textContent = 'Скрыть';
    flag = false;
    return;
  }
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_0__["Pagination"]]); //Function for incertion slider clasess into the elements

var addSliderClasses = function addSliderClasses(className) {
  var withoutLastSlide = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  ...
  for (var i = 0; i < wrap.children.length - countVal; i++) {
    wrap.children[i].classList.add('swiper-slide');
  }
};

if (document.documentElement.clientWidth < 564) {
  addSliderClasses('.repair-cards', true); //swiper init

  var swiperRepair = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.repair-main', {
    loop: false,
    slidesPerView: 1.2,
    freeMode: true,
    spaceBetween: 10,
  ...
  var swiperTech = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.tech-main', {
    loop: false,
    slidesPerView: 1.2,
    freeMode: true,
    spaceBetween: 10,
...
if (document.documentElement.clientWidth <= 1120) {
  ...
  var menuNavigationSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.menu-navigation', {
    loop: false,
    slidesPerView: 1.1,
    freeMode: true,
    spaceBetween: 10,
...
showBtn.addEventListener('click', function () {
  ...
  if (flag) {
    ...
    techCards.setAttribute('style', " height: ".concat(elemsAmount / elemsInRow * elemHeight, "px;\n                                        transition: height;\n                                        transition-duration: 0.7s;\n                                        transition-timing-function: ease-in;"));
    showBtn.textContent = 'Скрыть';
    flag = false;
  } else {
    showBtn.textContent = 'Показать все';
